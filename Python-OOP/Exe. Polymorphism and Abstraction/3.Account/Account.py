class Account:
    ...
    @classmethod
    def create_class(cls, owner, amount, transactions):
        # cls(owner, amount)._transaction.append(transactions)
    ...
    def __add__(self, other):
        ...
        transaction = self._transactions + self._transactions
        a = Account.create_class(name, amount, transaction)
        for el in transaction:
            a._transactions.append(el)
        return a
